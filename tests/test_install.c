...
int main(void)
{
    ...
    passed += kenc_installed_assets_open(NULL, 1u, "/", 1u, NULL, NULL) == KENC_ERR_INVALID ? 1u : 0u;
    passed += kenc_installed_assets_files(NULL) == NULL ? 1u : 0u;
